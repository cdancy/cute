...
public class ChatUI extends JComponent implements Runnable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -1494499525205235231L;
	...
	public void createComponents(){
		...
		JLabel label = new JLabel("Not in this Version!!!");
