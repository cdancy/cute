...
public class PreferencesUI extends JComponent implements Runnable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 5780896773224455229L;
